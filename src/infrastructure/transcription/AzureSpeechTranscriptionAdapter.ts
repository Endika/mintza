...
import type { AzureSpeechClient } from './AzureSpeechClient';

export class AzureSpeechTranscriptionAdapter implements TranscriptionPort {
  constructor(private readonly client: AzureSpeechClient) {}
